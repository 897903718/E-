...
public abstract class AsyncTask<Params, Progress, Result>
{
     ...
     */
    public static final Executor SERIAL_EXECUTOR = AndroidVersion.hasHoneycomb() ? new SerialExecutor() : Executors.newSingleThreadExecutor(sThreadFactory);
    ...
    public enum Status
    {
        ...
        RUNNING,
        /**
         * Indicates that @link com.example.android.displayingbitmaps.util.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     * @link com.example.android.displayingbitmaps.util.AsyncTask.Status#RUNNING} or @link com.example.android.displayingbitmaps.util.AsyncTask
     * .Status#FINISHED}.
