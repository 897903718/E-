...
import com.chanlytech.unicorn.imageloader.core.assist.ViewScaleType;
import com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware;
import com.chanlytech.unicorn.imageloader.core.imageaware.ImageViewAware;
import com.chanlytech.unicorn.imageloader.core.imageaware.NonViewAware;
import com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener;
import com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingProgressListener;
import com.chanlytech.unicorn.imageloader.core.listener.SimpleImageLoadingListener;
import com.chanlytech.unicorn.imageloader.utils.ImageSizeUtils;
...
public class ImageLoader
{
     ...
     * @param imageAware
     *         {@linkplain com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware Image aware view}
     ...
     *         which should display image
     * @param listener
     *         {@linkplain com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener Listener} for image loading process. Listener fires events on
     ...
     *         which should display image
     * @param options
     *         {@linkplain com.chanlytech.unicorn.imageloader.core.DisplayImageOptions Options} for image
     ...
     *         from configuration} will be used.
     * @param listener
     *         {@linkplain com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener Listener} for image loading process. Listener fires
     *         events on UI thread if this method is called on UI thread.
     * @param progressListener
     *         {@linkplain com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingProgressListener
     *         Listener} for image loading progress. Listener fires events on UI thread if this method
     *         is called on UI thread. Caching on disk should be enabled in
     *         {@linkplain com.chanlytech.unicorn.imageloader.core.DisplayImageOptions options} to make
     *         this listener work.
     *
     * @throws IllegalStateException
     *         if {@link #init(ImageLoaderConfiguration)} method wasn't called before
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options, ImageLoadingListener listener, ImageLoadingProgressListener progressListener)
    {
        ...
        if (TextUtils.isEmpty(uri))
        {
            ...
            {
                //                setImageDrawable(options.getImageForEmptyUri(configuration.resources), imageAware);
    ...
    //    /**
    //     * set imageDrawable with fade in
    //     *
    //     * @param drawable
    //     *         handle drawable
    //     * @param imageView
    //     */
    //    private void setImageDrawable(Drawable drawable, ImageAware imageView)
    //    {
    ...
    {
        displayImage(true, uri, imageView);
    }

    public void displayImage(boolean isAnimation, String uri, ImageView imageView)
    {
        displayImage(uri, new ImageViewAware(isAnimation, imageView), null, null, null);
    }
    ...
    {
        displayImage(true, uri, imageView, options, listener);
    }

    public void displayImage(boolean isAnimation, String uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener)
    {
        displayImage(isAnimation, uri, imageView, options, listener, null);
    }
    ...
    public void displayImage(boolean isAnimation, String uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener, ImageLoadingProgressListener progressListener)
    {
        displayImage(uri, new ImageViewAware(isAnimation, imageView), options, listener, progressListener);
    }

    /**
     * Adds load image task to execution pool. Image will be returned with
     * {@link com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener#onLoadingComplete(String, android.view.View, android.graphics.Bitmap)} callback}.
     * <br />
     * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
     *
     * @param uri
     *         Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
     * @param listener
     *         {@linkplain com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener Listener} for image loading process. Listener fires events on UI
     ...
     *         Minimal size for {@link android.graphics.Bitmap} which will be returned in
     *         {@linkplain com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener#onLoadingComplete(String, android.view.View,
     ...
     *         Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
     * @param targetImageSize
     *         Minimal size for {@link android.graphics.Bitmap} which will be returned. Downloaded image will be decoded
     *         and scaled to {@link android.graphics.Bitmap} of the size which is <b>equal or larger</b> (usually a bit
     *         larger) than incoming targetImageSize.
     *
     * @return Result image Bitmap. Can be <b>null</b> if image loading/decoding was failed or cancelled.
     ...
     * {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware ImageAware}
     */
     ...
     *
     * @param imageAware
     *         {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware ImageAware} for
     ...
     * {@link com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener#onLoadingFailed(String, android.view.View, com.chanlytech.unicorn.imageloader.core.assist.FailReason)} callback will be fired with
     * {@link com.chanlytech.unicorn.imageloader.core.assist.FailReason.FailType#NETWORK_DENIED}
     *
     * @param denyNetworkDownloads
     *         pass <b>true</b> - to deny engine to download images from the network; <b>false</b> -
    ...
    /**
     * Sets option whether ImageLoader will use {@link com.chanlytech.unicorn.imageloader.core.assist.FlushedInputStream} for network downloads to handle <a
     * href="http://code.google.com/p/android/issues/detail?id=6066">this known problem</a> or not.
     *
     * @param handleSlowNetwork
     *         pass <b>true</b> - to use {@link com.chanlytech.unicorn.imageloader.core.assist.FlushedInputStream} for network downloads; <b>false</b>
     *         - otherwise.
     */
     ...
     * {@linkplain com.chanlytech.unicorn.imageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
