 ...
 *******************************************************************************/
package com.chanlytech.unicorn.imageloader.core.imageaware;
 ...
 * through {@link com.chanlytech.unicorn.imageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
 ...
 * @see ViewAware
 * =======
 * @see com.chanlytech.unicorn.imageloader.core.imageaware.ViewAware
...
public interface ImageAware
{
    ...
    /**
     * Returns {@linkplain com.chanlytech.unicorn.imageloader.core.assist.ViewScaleType scale type} which is used for
     ...
     * {@link com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
     ...
     * {@linkplain com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
     *android.graphics.drawable.Drawable) for empty Uri},
     * {@linkplain com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
     *android.graphics.drawable.Drawable) on loading} or
     * {@linkplain com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#showImageOnFail(
     *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
     * {@linkplain com.chanlytech.unicorn.imageloader.core.DisplayImageOptions display options}.<br />
     * Also can be called in {@link com.chanlytech.unicorn.imageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
     * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
     *
     ...
     * {@link com.chanlytech.unicorn.imageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
     * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
     *
