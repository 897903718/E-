...
public class ImageViewAware extends ViewAware
{
    ...
    public ImageViewAware(boolean isAnimation, ImageView imageView)
    {
        this(imageView);
     ...
     *         <b>true</b> - then {@link #getWidth()} and {@link #getHeight()} will check actual
     ...
     *         But it helps to exec memory because memory cache keeps bitmaps of actual (less in
     *         general) size.
     *         <p/>
