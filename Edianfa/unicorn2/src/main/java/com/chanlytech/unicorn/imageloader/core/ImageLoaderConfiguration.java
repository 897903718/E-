...
import com.chanlytech.unicorn.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.chanlytech.unicorn.imageloader.core.assist.FlushedInputStream;
import com.chanlytech.unicorn.imageloader.core.assist.ImageSize;
...
import com.chanlytech.unicorn.imageloader.utils.MemoryCacheUtils;
 ...
 * =======
 * Presents configuration for {@link com.chanlytech.unicorn.imageloader.core.ImageLoader}
 * @see com.chanlytech.unicorn.imageloader.core.ImageLoader
 * @see MemoryCache
 * @see DiskCache
 * @see com.chanlytech.unicorn.imageloader.core.DisplayImageOptions
 * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
 * @see com.chanlytech.unicorn.imageloader.core.download.ImageDownloader
...
public final class ImageLoaderConfiguration
{
     ...
     * =======
     * Creates default configuration for {@link com.chanlytech.unicorn.imageloader.core.ImageLoader} <br />
     * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
     * <b>Default values:</b>
     * <ul>
     ...
     * <li>threadPoolSize = {@link com.chanlytech.unicorn.imageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_POOL_SIZE this}</li>
     * <li>threadPriority = {@link com.chanlytech.unicorn.imageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_PRIORITY this}</li>
     ...
     * <li>diskCache = {@link com.chanlytech.unicorn.imageloader.cache.disc.impl.UnlimitedDiscCache}</li>
     ...
     * =======
     * <li>defaultDisplayImageOptions = {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions#createSimple() Simple options}</li>
     * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
     * <li>tasksProcessingOrder = {@link com.chanlytech.unicorn.imageloader.core.assist.QueueProcessingType#FIFO}</li>
     ...
     * =======
     * Builder for {@link com.chanlytech.unicorn.imageloader.core.ImageLoaderConfiguration}
     * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
     *
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     */
    public static class Builder
    {
        ...
        /**
         * @deprecated Use
         * {@link #diskCacheExtraOptions(int, int, com.chanlytech.unicorn.imageloader.core.process.BitmapProcessor)}
         * instead
         */
        @Deprecated
         ...
         *         null-ok; {@linkplain com.chanlytech.unicorn.imageloader.core.process.BitmapProcessor Bitmap processor} which process images before saving them in disc cache
         */
         ...
         * <li>{@link #tasksProcessingOrder(com.chanlytech.unicorn.imageloader.core.assist.QueueProcessingType)}</li>
         * </ul>
         *
         ...
         * Default value - {@link com.chanlytech.unicorn.imageloader.core.assist.QueueProcessingType#FIFO}
         */
         ...
         * {@link com.chanlytech.unicorn.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
         ...
         * Default value - {@link com.chanlytech.unicorn.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link com.chanlytech.unicorn.imageloader.cache.disc.impl.ext.LruDiscCache LruDiscCache}
        ...
        /**
         * @deprecated Use {@link #diskCacheFileNameGenerator(com.chanlytech.unicorn.imageloader.cache.disc.naming.FileNameGenerator)}
         */
        @Deprecated
         ...
         * Default value -
         * {@link com.chanlytech.unicorn.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
        ...
        /**
         * @deprecated Use {@link #diskCache(com.chanlytech.unicorn.imageloader.cache.disc.DiskCache)}
         */
        @Deprecated
         ...
         * Default value - {@link com.chanlytech.unicorn.imageloader.cache.disc.impl.UnlimitedDiscCache
         * BaseDiscCache}. Cache directory is defined by
         * {@link com.chanlytech.unicorn.imageloader.utils.StorageUtils#getCacheDirectory(android.content.Context)
         ...
         * Default value -
         * {@link com.chanlytech.unicorn.imageloader.core.DefaultConfigurationFactory#createImageDownloader(android.content.Context)
         ...
         * Default value -
         * {@link com.chanlytech.unicorn.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
         ...
         * =======
         * Sets default {@linkplain com.chanlytech.unicorn.imageloader.core.DisplayImageOptions display image options} for image displaying. These options will
         * be used for every {@linkplain com.chanlytech.unicorn.imageloader.core.ImageLoader#displayImage(String, android.widget.ImageView) image display call}
         * without passing custom {@linkplain com.chanlytech.unicorn.imageloader.core.DisplayImageOptions options}<br />
         * Default value - {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions#createSimple() Simple options}
         * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
         */
         ...
         * =======
         * Enables detail logging of {@link com.chanlytech.unicorn.imageloader.core.ImageLoader} work. To prevent detail logs don't call this method.
         * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
         * Consider {@link com.chanlytech.unicorn.imageloader.utils.L#disableLogging()} to disable
         ...
         * =======
         * Builds configured {@link com.chanlytech.unicorn.imageloader.core.ImageLoaderConfiguration} object
         * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
         */
     ...
     * using {@link com.chanlytech.unicorn.imageloader.core.assist.FlushedInputStream}.
     *
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     * @since 1.8.1
     */
