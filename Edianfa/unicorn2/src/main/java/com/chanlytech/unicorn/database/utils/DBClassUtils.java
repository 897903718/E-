 ...
 */
package com.chanlytech.unicorn.database.utils;
...
import com.chanlytech.unicorn.database.table.Property;
import com.chanlytech.unicorn.exception.database.DBException;
import com.chanlytech.unicorn.utils.ClassUtils;
...
public class DBClassUtils
{
    ...
    {
        return FieldUtils.getFieldValue(entity, DBClassUtils.getPrimaryKeyField(entity.getClass()));
    }
    ...
    public static String getPrimaryKeyColumn(Class<?> clazz)
    {
        ...
        List<Field> fields = ClassUtils.getDeclaredFields(clazz);
    ...
    public static List<Property> getPropertyList(Class<?> clazz)
    {
        ...
        try
        {
            ...
            List<Field> fs = ClassUtils.getDeclaredFields(clazz);
