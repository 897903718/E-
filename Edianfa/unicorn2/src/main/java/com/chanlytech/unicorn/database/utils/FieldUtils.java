...
import com.chanlytech.unicorn.annotation.sqlite.Property;
...
public class FieldUtils
{
    ...
    public static Method getBooleanFieldGetMethod(Class<?> clazz, String fieldName)
    {
        ...
        try
        {
            return ClassUtils.getDeclaredMethod(mn, clazz);
    ...
    public static Method getBooleanFieldSetMethod(Class<?> clazz, Field f)
    {
        ...
        try
        {
            return ClassUtils.getDeclaredMethod(mn, clazz, f);
    ...
    public static Field getFieldByColumnName(Class<?> clazz, String columnName)
    {
        ...
        if (columnName != null)
        {
            ...
            {
                if (columnName.equals(DBClassUtils.getPrimaryKeyColumn(clazz)))
                {
                    field = DBClassUtils.getPrimaryKeyField(clazz);
                }
