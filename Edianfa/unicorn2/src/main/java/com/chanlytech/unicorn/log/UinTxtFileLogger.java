 ...
 */
public class UinTxtFileLogger implements ILogger
{
    ...
    {
        UinLog.println(priority, tag, message);
    ...
    {
        return android.os.Environment.getExternalStorageDirectory().getPath() + File.separator + "UinLog" + ".log";
    }
