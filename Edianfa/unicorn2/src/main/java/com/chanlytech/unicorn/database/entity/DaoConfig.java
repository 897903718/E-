...
package com.chanlytech.unicorn.database.entity;
...
public class DaoConfig
{
    ...
    private String  mDbName   = "chanlytech.db"; // 数据库名字
    private int     dbVersion = 1; // 数据库版本
    private boolean debug     = true; // 是否是调试模式（调试模式 增删改查的时候显示SQL语句）
    private IDBUpdateListener dbUpdateListener;
    ...
    public IDBUpdateListener getDbUpdateListener()
    {
        return dbUpdateListener;
    }

    public void setDbUpdateListener(IDBUpdateListener dbUpdateListener)
    {
