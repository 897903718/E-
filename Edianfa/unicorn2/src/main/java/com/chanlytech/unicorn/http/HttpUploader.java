...
import com.chanlytech.unicorn.cache.AsyncTask;
...
public class HttpUploader
{
     ...
     *         上传监听，完成，失败或者正在上传
     */
    public void uploadFileInBack(String url, Map<String, Object> param, IProgressListener loadListener)
    {
    ...
    private class HttpPostAsyncTask extends AsyncTask<String, Long, String>
    {
        ...
        public HttpPostAsyncTask(ArrayList<NameValuePair> valuePairs, IProgressListener listener)
        {
