 ...
 *******************************************************************************/
package com.chanlytech.unicorn.imageloader.core.process;
...
public interface BitmapProcessor
{
     ...
     * =======
     * <b>Note:</b> If this processor is used as {@linkplain DisplayImageOptions.Builder#preProcessor(com.chanlytech.unicorn.imageloader.core.process.BitmapProcessor)
     ...
     *
     * @param bitmap
     *         Original {@linkplain android.graphics.Bitmap bitmap}
     *
