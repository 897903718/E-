...
public class FileCache extends AbstractCache<String, byte[]> {
    ...
    public void addBufferToCache(String data, byte[] buffer) {
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                UinLog.i(TAG, "缓存数据到磁盘[key:" + data + ",hashKey:" + key + "]");
                ...
                try {
                    ...
                    UinLog.e(TAG, "addBufferToCache - " + e);
                } finally {
                    try {
                        if (out != null) {
                            out.close();
    ...
    public byte[] getBufferFromMemoryCache(String data) {
        ...
        try {
            ...
            UinLog.e(TAG, "获取缓存数据失败！" + UinLog.getPrintException(e));
        }
        return memValue;
    }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    UinLog.e(TAG, "getBufferFromDiskCache - " + e);
                } catch (Exception e) {
                    e.printStackTrace();
                    UinLog.e(TAG, "getBufferFromDiskCache - " + e);
                } finally {
