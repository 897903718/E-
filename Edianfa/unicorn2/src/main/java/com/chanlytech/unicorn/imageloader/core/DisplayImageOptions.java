 ...
 * <ul>
 * <li>whether stub image will be displayed in {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware
 ...
 * <li>whether {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware image aware view} should be reset
 ...
 * <li>auxiliary object which will be passed to {@link com.chanlytech.unicorn.imageloader.core.download.ImageDownloader#getStream(String, Object) ImageDownloader}</li>
 ...
 * <ul>
 * <li>with {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder}:<br />
 * <b>i.e.</b> :
 * <<<<<<< HEAD
 * <code>new {@link DisplayImageOptions}.{@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#Builder() Builder()}.{@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#cacheInMemory() cacheInMemory()}.
 * =======
 * <code>new {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions}.{@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#Builder() Builder()}.{@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#cacheInMemory() cacheInMemory()}.
 * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
 * {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#showImageOnLoading(int) showImageOnLoading()}.{@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#build() build()}</code><br />
 * </li>
...
public final class DisplayImageOptions
{
     ...
     * =======
     * Builder for {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions}
     * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
     *
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     */
    public static class Builder
    {
        ...
        /**
         * Stub image will be displayed in {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware
        ...
        /**
         * Incoming image will be displayed in {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware
         * image aware view} during image loading
         *
         * @param imageRes
         *         Image resource
        ...
        /**
         * Incoming drawable will be displayed in {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware
         * image aware view} during image loading.
         * This option will be ignored if {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#showImageOnLoading(int)} is set.
         */
         ...
         * image aware view} if empty URI (null or empty
         * string) will be passed to <b>ImageLoader.displayImage(...)</b> method.
         * This option will be ignored if {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(int)} is set.
         */
         ...
         * image aware view} if some error occurs during
         * requested image loading/decoding.
         * This option will be ignored if {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions.Builder#showImageOnFail(int)} is set.
         */
        ...
        /**
         * {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware
        ...
        /**
         * Sets whether {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware
         * image aware view} will be reset (set <b>null</b>) before image loading start
         */
        ...
        /**
         * Sets {@linkplain com.chanlytech.unicorn.imageloader.core.assist.ImageScaleType scale type} for decoding image. This parameter is used while define scale
         * size for decoding image to Bitmap. Default value - {@link com.chanlytech.unicorn.imageloader.core.assist.ImageScaleType#IN_SAMPLE_POWER_OF_2}
         */
         ...
         * calculate the most appropriate sample size itself according yo {@link #imageScaleType(com.chanlytech.unicorn.imageloader.core.assist.ImageScaleType)}
         * options.<br />
        ...
        /**
         * Sets auxiliary object which will be passed to {@link com.chanlytech.unicorn.imageloader.core.download.ImageDownloader#getStream(String, Object)}
         */
         ...
         * {@link com.chanlytech.unicorn.imageloader.core.imageaware.ImageAware image aware view} but
        ...
        /**
         * Sets custom {@link com.chanlytech.unicorn.imageloader.core.display.BitmapDisplayer displayer} for image loading task. Default value -
        ...
        /**
         * Sets custom {@linkplain android.os.Handler handler} for displaying images and firing {@linkplain com.chanlytech.unicorn.imageloader.core.listener.ImageLoadingListener
         * listener} events.
         */
        ...
        /**
         * Builds configured {@link com.chanlytech.unicorn.imageloader.core.DisplayImageOptions} object
         */
     ...
     * <li>{@link com.chanlytech.unicorn.imageloader.core.assist.ImageScaleType#IN_SAMPLE_POWER_OF_2} decoding type will be used</li>
     * <li>{@link android.graphics.Bitmap.Config#ARGB_8888} bitmap config will be used for image decoding</li>
     * <li>{@link com.chanlytech.unicorn.imageloader.core.display.SimpleBitmapDisplayer} will be used for image displaying</li>
     * </ul>
     * <p/>
