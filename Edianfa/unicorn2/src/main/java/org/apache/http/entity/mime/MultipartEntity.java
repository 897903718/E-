...
public class MultipartEntity implements HttpEntity
{
     ...
     *
     * @param mode
     *         the mode to use, may be {@code null}, in which case {@link org.apache.http.entity.mime.HttpMultipartMode#STRICT} is used
     * @param boundary
     *         the boundary string, may be {@code null}, in which case {@link #generateBoundary()} is invoked to create the string
     *         <<<<<<< HEAD
     * @param charset
     *         the character set to use, may be {@code null}, in which case {@link MIME#DEFAULT_CHARSET} - i.e. US-ASCII - is used.
     *         =======
     * @param charset
     *         the character set to use, may be {@code null}, in which case {@link org.apache.http.entity.mime.MIME#DEFAULT_CHARSET} - i.e. US-ASCII - is used.
    ...
    /**
     * Creates an instance using the specified {@link org.apache.http.entity.mime.HttpMultipartMode} mode.
    ...
    /**
     * Creates an instance using mode {@link org.apache.http.entity.mime.HttpMultipartMode#STRICT}
     */
