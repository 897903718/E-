 ...
 * data using arbitrary {@link org.apache.http.io.SessionInputBuffer} and
 * {@link org.apache.http.io.SessionOutputBuffer} implementations.
 * <p/>
...
public abstract class AbstractHttpServerConnection implements HttpServerConnection
{
    ...
    /**
     * Creates an instance of {@link org.apache.http.impl.entity.EntityDeserializer} with the
     * {@link org.apache.http.impl.entity.LaxContentLengthStrategy} implementation to be used for
     * de-serializing entities received over this connection.
     * <p/>
     * This method can be overridden in a super class in order to create
     * instances of {@link org.apache.http.impl.entity.EntityDeserializer} using a custom
    ...
    /**
     * Creates an instance of {@link org.apache.http.impl.entity.EntitySerializer} with the
     * {@link org.apache.http.impl.entity.StrictContentLengthStrategy} implementation to be used for
     * serializing HTTP entities sent over this connection.
     * <p/>
     * This method can be overridden in a super class in order to create
     * instances of {@link org.apache.http.impl.entity.EntitySerializer} using a custom
     * {@link org.apache.http.entity.ContentLengthStrategy}.
     *
     ...
     * =======
     * Creates an instance of {@link org.apache.http.impl.DefaultHttpRequestFactory} to be used
     * >>>>>>> 3d93dda83bebe4abb74f4bd33ca8ab71908e18a9
     * for creating {@link org.apache.http.HttpRequest} objects received by over this
     * connection.
     * <p/>
     * This method can be overridden in a super class in order to provide
     * a different implementation of the {@link org.apache.http.HttpRequestFactory} interface.
     *
    ...
    /**
     * Creates an instance of {@link org.apache.http.io.HttpMessageParser} to be used for parsing
     * HTTP requests received over this connection.
     * <p/>
     * This method can be overridden in a super class in order to provide
     * a different implementation of the {@link org.apache.http.io.HttpMessageParser} interface or
     * to pass a different implementation of the
     * {@link org.apache.http.message.LineParser} to the
     * {@link org.apache.http.impl.io.DefaultHttpRequestParser} constructor.
     *
     * @param buffer
    ...
    /**
     * Creates an instance of {@link org.apache.http.io.HttpMessageWriter} to be used for
     * writing out HTTP responses sent over this connection.
     * <p/>
     * This method can be overridden in a super class in order to provide
     * a different implementation of the {@link org.apache.http.io.HttpMessageWriter} interface or
     * to pass a different implementation of
     * {@link org.apache.http.message.LineFormatter} to the the default
     * implementation {@link org.apache.http.impl.io.HttpResponseWriter}.
     *
     * @param buffer
    ...
    /**
     * Initializes this connection object with {@link org.apache.http.io.SessionInputBuffer} and
     * {@link org.apache.http.io.SessionOutputBuffer} instances to be used for sending and
     ...
     * {@link #createRequestParser(org.apache.http.io.SessionInputBuffer, org.apache.http.HttpRequestFactory, org.apache.http.params.HttpParams)}
     * and {@link #createResponseWriter(org.apache.http.io.SessionOutputBuffer, org.apache.http.params.HttpParams)}
