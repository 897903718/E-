 ...
 * <p/>
 * <<<<<<< HEAD
 * @deprecated (4.3) use {@link org.apache.http.impl.io.SessionOutputBufferImpl}
...
public abstract class AbstractSessionOutputBuffer implements SessionOutputBuffer, BufferInfo
{
    ...
    protected void init(final OutputStream outstream, final int buffersize, final HttpParams params)
    {
        ...
        this.metrics = createTransportMetrics();
        final CodingErrorAction a1 = (CodingErrorAction) params.getParameter(CoreProtocolPNames.HTTP_MALFORMED_INPUT_ACTION);
        this.onMalformedCharAction = a1 != null ? a1 : CodingErrorAction.REPORT;
        final CodingErrorAction a2 = (CodingErrorAction) params.getParameter(CoreProtocolPNames.HTTP_UNMAPPABLE_INPUT_ACTION);
