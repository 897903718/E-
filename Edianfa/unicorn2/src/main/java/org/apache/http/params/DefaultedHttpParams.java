 ...
 * =======
 * {@link org.apache.http.params.HttpParams} implementation that delegates resolution of a parameter
 * to the given default {@link org.apache.http.params.HttpParams} instance if the parameter is not
...
public final class DefaultedHttpParams extends AbstractHttpParams
{
     ...
     *         if either the local or default HttpParams instances do not implement HttpParamsNames
     * @since 4.2
     */
    @Override
     ...
     *
     * @throws UnsupportedOperationException
     *         if the default HttpParams instance does not implement HttpParamsNames
     * @since 4.2
     */
     ...
     *
     * @throws UnsupportedOperationException
     *         if the local HttpParams instance does not implement HttpParamsNames
     * @since 4.2
     */
