...
public class BasicHeaderValueFormatter implements HeaderValueFormatter
{
     ...
     *
     * @param elem
     *         the header element to format, or <code>null</code>
     *
     * @return a length estimate, in number of characters
     */
     ...
     *
     * @param nvps
     *         the parameters to format, or <code>null</code>
     *
     * @return a length estimate, in number of characters
     */
     ...
     *
     * @param nvp
     *         the name-value pair to format, or <code>null</code>
     *
     * @return a length estimate, in number of characters
     */
     ...
     *
     * @param buffer
     *         the buffer to append to, never <code>null</code>
     * @param value
