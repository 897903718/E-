...
public class VersionInfo
{
     ...
     *         the package
     * @param module
     *         the module, or <code>null</code>
     * @param release
     *         the release, or <code>null</code>
     * @param time
     *         the build time, or <code>null</code>
     * @param clsldr
    ...
    {
        final StringBuilder sb = new StringBuilder(20 + infoPackage.length() + infoModule.length() +
     ...
     * @param clsldr
     *         the classloader, or <code>null</code>
     *
     ...
     *
     * @param name
     *         the component name, like "Apache-HttpClient".
     * @param pkg
