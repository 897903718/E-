...
public abstract class AbstractMessageParser<T extends HttpMessage> implements HttpMessageParser<T>
{
     ...
     *         <<<<<<< HEAD
     *
     * @deprecated (4.3) use {@link org.apache.http.impl.io.AbstractMessageParser#AbstractMessageParser(org.apache.http.io.SessionInputBuffer,
     ...
     *         the session input buffer.
     * @param lineParser
     *         the line parser. If <code>null</code> {@link org.apache.http.message.BasicLineParser#INSTANCE}
     *         will be used.
     * @param constraints
