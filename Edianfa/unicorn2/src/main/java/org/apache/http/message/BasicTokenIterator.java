...
/**
 * Basic implementation of a {@link org.apache.http.TokenIterator}.
...
public class BasicTokenIterator implements TokenIterator
{
     ...
     * =======
     * Creates a new instance of {@link org.apache.http.message.BasicTokenIterator}.
    ...
    protected int findTokenSeparator(final int pos)
    {
        ...
        while (!found && (from < to))
        {
            ...
            {
                throw new ParseException("Tokens without separator (pos " + from +
                        "): " + this.currentHeader);
            }
            else
            {
                throw new ParseException("Invalid character after token (pos " + from +
                        "): " + this.currentHeader);
            }
        }
