...
public class HttpMultipart extends AbstractMultipartForm
{
     ...
     * @param charset
     *         the character set to use. May be {@code null},
     *         <<<<<<< HEAD
     *         in which case {@link MIME#DEFAULT_CHARSET} - i.e. US-ASCII - is used.
     *         =======
     *         in which case {@link org.apache.http.entity.mime.MIME#DEFAULT_CHARSET} - i.e. US-ASCII - is used.
    ...
    /**
     * Creates an instance with the specified settings.
     * Mode is set to {@link org.apache.http.entity.mime.HttpMultipartMode#STRICT}
     *
     * @param subType
     *         MIME subtype - must not be {@code null}
     * @param charset
