 ...
 * =======
 * Default implementation of {@link org.apache.http.protocol.HttpProcessor}.
...
public final class BasicHttpProcessor implements HttpProcessor, HttpRequestInterceptorList, HttpResponseInterceptorList, Cloneable
{
    ...
    {
        for (final Iterator<HttpRequestInterceptor> it = this.requestInterceptors.iterator(); it.hasNext(); )
        {
    ...
    {
        for (final Iterator<HttpResponseInterceptor> it = this.responseInterceptors.iterator(); it.hasNext(); )
        {
            final Object request = it.next();
            if (request.getClass().equals(clazz))
            {
