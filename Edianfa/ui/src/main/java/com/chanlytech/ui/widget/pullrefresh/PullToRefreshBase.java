...
import com.chanlytech.ui.widget.pullrefresh.internal.FlipLoadingLayout;
import com.chanlytech.ui.widget.pullrefresh.internal.LoadingLayout;
import com.chanlytech.ui.widget.pullrefresh.internal.RotateLoadingLayout;
import com.chanlytech.ui.widget.pullrefresh.internal.Utils;
import com.chanlytech.ui.widget.pullrefresh.internal.ViewCompat;
...
//    boolean isSetHeight = false;
    public final  void moveTo(int height)
    {
//        isSetHeight = true;
...
//        }
    ...
    /**
     * @return Either {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.Orientation#VERTICAL} or
     * {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
     */
     ...
     * {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.State#PULL_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.State#REFRESHING} or {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.State#MANUAL_REFRESHING} state.
     *
     * @param doScroll
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.State#RESET} state.
     */
    ...
    protected final Parcelable onSaveInstanceState()
    {
        ...
        // Let derivative classes get a chance to exec state first, that way we
    ...
    private final void smoothScrollTo(int scrollValue, long duration)
{
    ...
    public static interface OnPullEventListener<V extends View>
    {
         ...
         * @param direction
         *         - One of {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.Mode#PULL_FROM_START} or
         *         {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
         *         the user is pulling. Only useful when <var>state</var> is
         *         {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.State#PULL_TO_REFRESH} or
         *         {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
         */
